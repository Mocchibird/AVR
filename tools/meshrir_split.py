...
parser.add_argument('--base_folder', default=None, required=True, help='/path/to/parent/folder')      # option that takes a value
...
pos_files = [d for d in os.listdir(dataset_path) if 'pos' in d] # pos_mic.npy and pos_src.npy files
